...
<head>
    ...
    <title>#WeWillWin - Register</title>
                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                <button type="submit" id="register" class="btn btn-danger">Submit</button>
                            </div>
                        </div>
                    </form>
                    <div class="form-group col-lg-12">
						<a href="login.php"><button type="submit" class="btn btn-warning">Already a member? Login here</button></a>
					</div>
