        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/covid1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/covid2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/covid3.jpg" alt="">
                            </div>
                        </div>
                    ...
                    <h1 class="brand-name">#WeWillWin</h1>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/covid4.png" alt="">
                    <hr class="visible-xs">
                    <p style="color:blue;font-family:calibri,sans-seriff,arial;">The COVID-19 pandemic, also known as the coronavirus pandemic, is an ongoing pandemic of coronavirus disease 2019 (COVID-19) caused by severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2), first identified in December 2019 in Wuhan, China. The outbreak was declared a Public Health Emergency of International Concern in January 2020 and a pandemic in March 2020. As of 4 November 2020, more than 47.5 million cases have been confirmed, with more than 1.21 million deaths attributed to COVID-19.
